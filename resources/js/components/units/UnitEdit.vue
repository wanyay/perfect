<template>
    <div class="masonry-item col-md-6 offset-3" style="position: absolute; left: 0%; top: 0px;">
        <div class="bgc-white p-20 bd"><h6 class="c-grey-900">Update Unit</h6>
            <div class="mT-30">
                <el-form
                    :model="form"
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="submitForm('unitUpdate')">Update</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </div>
        ...
        methods: {
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.post('units.'+ this.unit.id +'.update', this.form).then(response => {
