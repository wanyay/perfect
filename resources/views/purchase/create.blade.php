            ...
            <div class="ui segments">
                ...
                <div class="ui segment">
                    <div class="ui vertical fluid menu no-border no-radius">
											<div class="ui input">
												<input id="bCode" ng-model="searchKeyword" type="text" placeholder="Item Code" style="padding-left:-15px">
											</div>
                ...
                <div class="ui segments">
                      <div class="ui segment">
                        ...
                        {!! Form::open(['url' => '/purchases','class' => 'ui form segment form3'])!!}
                            ...
                            <select id="supplier" class="form-control" name = "supplier_id" ng-options="su.id as su.name for su in suppliers track by su.id" data-ng-model="selectedOption" required="required">
                     ...
                     <tbody>
											 <tr ng-repeat="newpurchasetemp in purchasedata">
                         ...
                         <td>
                            <input type="number" class="form-control" style="text-align:center" autocomplete="off"  ng-change="updatePurchaseTemp(newpurchasetemp)" ng-model="newpurchasetemp.qty" size="1">
                         </td>
                         <td>@{{newpurchasetemp.cost * newpurchasetemp.qty | currency}}</td>
                         <td>
                           <a class="btn btn-danger btn-xs" type="button" ng-click="showupdatePurchaseTemp(newpurchasetemp)">
                           <i class="icon blue edit" aria-hidden="true"></i></a>
                         </td>
                         <td>
                           <a class="btn btn-danger btn-xs" type="button" ng-click="removePurchaseTemp(newpurchasetemp.id)">
      ...
      <div class="ui small item modal">
          ...
          <div class="content">
            <div class="ui form">
              <div class="tow field">
                  ...
                  <div class="field">
                    <input type="text" ng-model="editpurchasecode" class = "form-control" placeholder="Name" ng-required>
              ...
              <div class="tow field">
                  ...
                  <div class="field">
                    <input class="form-control" type="text"  ng-model="editpurchasename" placeholder="Phone" ng-required>
                  </div>
              </div>
              ...
              <div class="tow field">
                  ...
                  <div class="field">
                      <input class="form-control" type="text"  ng-model="editpurchaseprice" placeholder="Phone" ng-required>
                  </div>
              </div>
              ...
              <div class="tow field">
                  ...
                  <div class="field">
                    <input class="form-control" type="text"  ng-model="editpurchasecost" placeholder="Phone" ng-required>
                  </div>
              </div>
              ...
              <div class="tow field">
                  ...
                  <div class="field">
                    <input class="form-control" type="text"  ng-model="editpurchaseqty" placeholder="Phone" ng-required>
                  </div>
              </div>
          ...
          <div class="actions">
              <div class="ui negative button">
                  ...
                  <a type="button" class="ui greenli button" ng-click="updatePurchase(editpurchaseid,editpurchasecode,editpurchasename,editpurchaseprice,editpurchasecost,editpurchaseqty)">Update</a>
          </div>
      </div>
