                ...
                <div class="sixteen wide column">
                    <div class="ui segments">
											<div class="ui segment no-padding-bottom">
												<h5 class="ui left floated header">New Unit</h5>
												<h5 class="ui right floated header">
													<a href="{{url('/units/create')}}" class="tiny ui greenli button"><i class="plus icon"></i>New</a>
												</h5>
                            ...
                            <div class="table-responsive">
                              <table id="data_table_info" class="ui compact selectable striped celled table" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                          <a href="{{ url('/units/'.$unit->id).'/edit'}}"><i class="edit icon"></i></a>

                                          <a onclick="fun_delete({{ $unit->id }})"><i class="red trash icon"></i></a>
                                        <center>
                                    </td>
                                </tr>
                                @endforeach
